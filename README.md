...
### 1. README.md:
Provides an overview and instructions for using the scripts and notebooks in this repository.

### 2. merge_split_for_accountants.ipynb:
...
### 3. merge_split_accounts_receivable.ipynb: 
...
### 5. specific_customer_format.ipynb:
